                                ...
                                <tbody>
                                    ...
                                    foreach ($roles as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php 
                                                    ...
                                                    foreach($users as $user){
                                                        if($user->getProperty('role') == $role->getProperty("name")){?>
                                            ...
                                            <td class="text-end">
                                                <a href="#<?php $role->getProperty("id"); ?>" class="btn btn-sm btn-neutral bi-pen"></a>
                                                <a href="#<?php $role->getProperty("id"); ?>" class="btn btn-sm btn-neutral bi-trash"></a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
